...
float sensorW[16] = { -0.60, -0.52, -0.44, -0.36, -0.28, -0.20, -0.12, -0.04, 0.04, 0.12, 0.20, 0.28, 0.36, 0.44, 0.52, 0.60 };
...
void loop() {
  ...
  while (true) {
    ...
    sensorRead();
    if(dVal[0] == 1 && dVal[1] == 1 && dVal[2] == 1 && dVal[3] == 1 && dVal[4] == 1&& dVal[5] == 1){ 
      goForward(200);  //Turn Right
      TurnRight(500);
    }

    else if (dVal[11] == 1, dVal[12] == 1, dVal[13] == 1 && dVal[14] == 1 && dVal[15] == 1&& dVal[10] == 1){
      goForward(200);  //Turn Right
      TurnLeft(500);
